...
const Clients = () => {
  const corporateClients = [
    "Mphasis", "Wipro", "AspireSys (Bahrain)", "Hexaware", "Accenture", 
    "Bank Of America", "HCL", "Emirates NBD (Dubai)", "Cognizant", "Nomura",
    "Verizon (USA)", "Infosys", "Inautix", "Ministry of Defence", "Kumaran Systems",
    "Nokia Siemens Networks", "JDA", "Mastek", "PayPal", "Dell", "Liberty Mutual"
  ];

  const partnerColleges = [
    "SRM Easwari", "PSGR Krishnammal College for Women", "NGP Arts and Science College",
    "Sairam Engineering College", "TJS Engineering College", 
    "Karpaga Vinayagar College of Engineering", "SMK Fomra Engineering College",
    "Tagore Engineering College", "Jaya Engineering College", "IFET Engineering College"
  ];
  ...
  return (
    <Layout>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              Over 45+ corporate clients and numerous educational institutions trust 
              Phoenix IT Consulting for their technology needs
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-muted/50">
        <div className="container">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl font-bold">Corporate Clients</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Leading IT companies, financial institutions, and government organizations 
              that have partnered with us for their technology initiatives
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="container">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl md:text-4xl font-bold">Global Client Distribution</h2>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    {region.clients.map((client, idx) => (
                      <div key={idx} className="text-sm text-center p-2 bg-muted/50 rounded">
                        {client}
                      </div>
                    ))}
                  </div>
      ...
      <section className="py-16 lg:py-24 bg-muted/50">
        <div className="container">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Collaborating with leading colleges and universities for student development programs
            </p>
          </div>
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-muted-foreground">Successful Implementation</span>
                  </div>
                </CardContent>
              </Card>
            ))}
